...
* [User Agent](https://github.com/HaraldWalker/user-agent-utils) - 是一个特殊字符串头，使得服务器能够识别客户使用的操作系统及版本、CPU 类型、浏览器及版本、浏览器渲染引擎、浏览器语言、浏览器插件等。
* [Google Guava](http://www.oschina.net/news/55071/guava-18) - Google的一个开源项目，包含许多Google核心的Java常用库
